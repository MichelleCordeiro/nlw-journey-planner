...
export function CreateTripPage() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState(['mic@gmail.com', 'diego@otmail.com'])
          ...
          <div className='w-[640px] rounded-xl px-6 py-5 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  <div className='px-2.5 py-1.5 rounded-md bg-zinc-800 flex items-center gap-2'>
          ...
          <div className='w-[640px] rounded-xl px-6 py-5 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              ...
              <p className='text-sm text-zinc-400'>
                ...
                <span className='font-semibold text-zinc-100'>Florianópolis, Brasil</span> nas datas
                de <span className='font-semibold text-zinc-100'>16 a 27 de Agosto de 2024</span>{' '}

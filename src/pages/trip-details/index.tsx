    ...
    <div className='max-w-6xl px-6 py-10 mx-auto space-y-8'>
      <div className='px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between'>
        <div className='flex items-center gap-2'>
          ...
          <span className='text-zinc-100'>Natal, Brasil</span>
        </div>

        <div className='flex items-center gap-5'>
          <div className='flex items-center gap-2'>
            <Calendar className='size-5 text-zinc-400' />
            <span className='text-zinc-100'>07 a 23 de Agosto</span>
          </div>
        ...
        <div className='flex-1 space-y-6'>
          ...
          <div className='space-y-8'>
            ...
            <div className='space-y-2.5'>
              ...
              <div className='space-y-2.5'>
                <div className='px-4 py-2.5 text-zinc-900 rounded-xl shadow-shape flex items-center gap-3'>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl px-6 py-5 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form className='space-y-3'>
              ...
              <div className='flex items-center gap-2'>
                <div className='flex-1 px-4 h-14 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                  ...
                  <input
                    type='datetime-local'
                    name='occurs_at'
                    placeholder='2Data e horãrio da atividade'
                    className='w-40 bg-transparent text-lg placeholder-zinc-400 outline-none flex-1 [cursor-scheme:pointer]'
                  />
                </div>
              </div>
              ...
              <button
                type='submit'
                className='bg-lime-300 text-lime-950 rounded-lg px-5 h-11 font-medium w-full flex items-center justify-center gap-2 hover:bg-lime-400'
              >
                Salvar atividade
              </button>
            </form>
